...
if(isset($_GET['id'])){
    ...
    $get_education = mysqli_query($conn, "SELECT * FROM `secondary_education` WHERE id=$id");
    
    while($fetch_data = mysqli_fetch_assoc($get_education)){
        $id = $fetch_data['id'];
        $strand = $fetch_data['strand'];
    ...
    if(isset($_POST['save_changes'])){
        ...
        $update_tbl = mysqli_query($conn, "UPDATE secondary_education SET 
            strand = '$form_strand', 
            school = '$form_school', 
            street = '$form_street', 
...
<body style="background-color: grey;">
    ...
    <div data-aos="fade-right" class="container container-custom form-container" 
        ...
        <h1 class="fs-5 mt-3">Edit secondary education</h1>
        <hr>
        <form class="d-flex flex-column" method="post">
            ...
            <div class="container2 gap-1" style="display: flex;">
                <div class="w-100">
                    ...
                    <input class="form-control" type="text" id="strand" value="<?php echo $strand; ?>" name="strand" 
