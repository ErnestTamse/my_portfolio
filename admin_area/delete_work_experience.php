...
if(isset($_GET['id'])){
    ...
    if(isset($_POST['delete_data'])){
        ...
        $delete_row = mysqli_query($conn, "DELETE FROM work_experience WHERE id=$id");

            if($delete_row) {
                echo "<script>alert('Work Experiece Successfully Deleted.')</script>";
...
<body style="background-color: grey;">
    ...
    <div data-aos="fade-right" class="container container-custom form-container w-50" 
        ...
        <h1 class="fs-5 mt-3">Are you sure you want to delete this work experience?</h1>
        <hr>
