...
if (isset($_POST['save_changes'])) {
    ...
    $insert_data = mysqli_query($conn, "INSERT INTO `tertiary_education` 
        (user_id, course, school, street, barangay, city, country, postal_code, school_address, school_year) 
        VALUE ($user_id, '$form_course', '$form_school', '$form_street', '$form_barangay', '$form_city', '$form_country', 
        '$form_postal_code', '$form_school_address', '$form_school_year')");

    if ($insert_data) {
        echo "<script>alert('Tertiary Education Successfully Added.')</script>";
...
<body style="background-color: grey;">
    ...
    <div data-aos="fade-right" class="container container-custom form-container" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%)">
        ...
        <h1 class="fs-5 mt-3">Add tertiary education</h1>
        <hr>
        <form class="d-flex flex-column" method="post">
            ...
            <div class="container2 gap-1" style="display: flex;">
                <div class="w-100">
                    ...
                    <input class="form-control" type="text" id="course" name="course" style="background-color: #DED1B7; border: 1px solid #262018;" required>
                </div>
                <div class="w-100">
