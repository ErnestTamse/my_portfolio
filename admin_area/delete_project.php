...
if(isset($_GET['id'])){
    ...
    $get_work = mysqli_query($conn, "SELECT * FROM `projects` WHERE id=$id");
    
    if(isset($_POST['delete_data'])){

        $delete_row = mysqli_query($conn, "DELETE FROM projects WHERE id=$id");
...
<body style="background-color: grey;">
    ...
    <div data-aos="fade-right" class="container container-custom form-container w-50" 
        ...
        <h1 class="fs-5 mt-3">Are you sure you want to delete this project?</h1>
        <hr>
