...
if(isset($_GET['id'])){
    ...
    $get_work = mysqli_query($conn, "SELECT * FROM `soft_skills` WHERE id=$id");
    
    if(isset($_POST['delete_data'])){

        $delete_row = mysqli_query($conn, "DELETE FROM soft_skills WHERE id=$id");
